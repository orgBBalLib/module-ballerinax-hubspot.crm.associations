...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through integrated tools designed to drive growth and improve customer relationships.
...
2. For full API access to CRM Associations endpoints, you will need a Professional or Enterprise plan subscription. Some basic API functionality may be available on free accounts, but advanced association features require a paid tier.
...
public function main() returns error? {
    hscrmassociations:BatchInputPublicDefaultAssociationMultiPost batchAssociations = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    hscrmassociations:BatchResponsePublicDefaultAssociation response = check hscrmassociationsClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(batchAssociations);
}
```
...
2. [Deal association workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-association-workflow) - Illustrates managing deal associations as part of a CRM workflow.
