...
2. Note that while HubSpot offers free tools, full API access and certain CRM features require a Professional or Enterprise plan subscription. Some API endpoints may have rate limits or restrictions based on your subscription tier.
...
6. Navigate to the **Scopes** tab and select the required scopes for CRM associations. At minimum, enable:
