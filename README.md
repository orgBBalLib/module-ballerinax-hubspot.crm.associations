...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through integrated tools designed to drive growth and build meaningful customer relationships.
...
2. If you intend to use private apps for API access, note that while HubSpot offers free tools, some API features and higher rate limits may require a Starter, Professional, or Enterprise subscription plan.
