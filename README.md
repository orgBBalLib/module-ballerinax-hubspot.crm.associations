...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage their marketing, sales, customer service, and content management activities in one unified system.
...
2. Note that while HubSpot offers a free CRM, certain API features and higher rate limits may require a paid subscription (Starter, Professional, or Enterprise plan). The Associations API is available across plans, but rate limits vary based on your subscription tier.
...
6. Navigate to the **Scopes** tab and select the required scopes for the Associations API (e.g., `crm.objects.contacts.read`, `crm.objects.contacts.write`, `crm.objects.companies.read`, `crm.objects.companies.write`, and other relevant object scopes).
...
2. [Customer onboarding associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/customer-onboarding-associations) - Illustrates managing associations during the customer onboarding process.
