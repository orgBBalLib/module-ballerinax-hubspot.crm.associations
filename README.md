...
8. Once the private app is created, navigate to the Auth tab to find your access token. Click Show token to reveal it.

> **Tip:** You must copy and store this key somewhere safe. It won't be visible again after you navigate away for security reasons, and you may need to regenerate it if lost.
## Quickstart
...
public function main() returns error? {
    hscrmassociations:BatchInputPublicFetchAssociationsBatchRequest payload = {
        inputs: [
            {
                id: "12345"
            }
    ...
    hscrmassociations:BatchResponsePublicAssociationMultiWithLabel|hscrmassociations:BatchResponsePublicAssociationMultiWithLabelWithErrors response = check hscrmassociationsClient->/associations/["contacts"]/["companies"]/batch/read.post(payload);
}
```
