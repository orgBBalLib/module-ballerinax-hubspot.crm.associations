...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that provides integrated solutions for marketing, sales, content management, and customer service to help businesses grow and manage customer relationships effectively.
...
public function main() returns error? {
    hscrmassoc:BatchInputPublicDefaultAssociationMultiPost associations = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    hscrmassoc:BatchResponsePublicDefaultAssociation response = check hscrmassocClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(associations);
}
```
