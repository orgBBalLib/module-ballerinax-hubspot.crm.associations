...
public function main() returns error? {
    ...
    hscrmassociations:BatchResponseLabelsBetweenObjectPair|hscrmassociations:BatchResponseLabelsBetweenObjectPairWithErrors response = check hscrmassociationsClient->/associations/["contacts"]/["companies"]/batch/create.post(newAssociations);
}
```
