...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content operations through a unified suite of tools designed to drive growth and improve customer relationships.
...
2. Note that while HubSpot offers free tools, full API access to CRM Associations features may require a Professional or Enterprise plan subscription depending on your use case and rate limit requirements.
...
8. Once created, your access token will be displayed. Copy the access token to use with the connector.
...
#### Create associations between records (default)
