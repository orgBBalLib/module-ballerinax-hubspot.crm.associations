...
final hscrmassociations:Client crmAssociationsClient = check new ({
    auth: {
        clientId,
        clientSecret,
        refreshToken
...
public function main() returns error? {
    ...
    hscrmassociations:BatchResponsePublicDefaultAssociation response = check crmAssociationsClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(payload);
}
```
