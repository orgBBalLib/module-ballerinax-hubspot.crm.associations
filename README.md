...
2. For full access to the CRM Associations API, you will need a Professional or Enterprise plan subscription. Some association features may be limited on free or Starter plans.
...
6. Navigate to the **Scopes** tab and select the required scopes for CRM associations. At minimum, enable `crm.objects.contacts.read`, `crm.objects.contacts.write`, and `crm.schemas.contacts.read` along with other object scopes as needed.
