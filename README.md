...
public function main() returns error? {
    hscrmassociations:BatchInputPublicDefaultAssociationMultiPost batchAssociation = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    hscrmassociations:BatchResponsePublicDefaultAssociation response = check hscrmassociationsClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(batchAssociation);
}
```
