...
2. If you intend to use private apps for API access, note that creating private apps requires a HubSpot account with Super Admin permissions. Additionally, some API features may require a Professional or Enterprise plan subscription.
...
8. Once the private app is created, you will see the access token displayed. Click Show token to reveal it, then copy the token.
