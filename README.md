...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage their marketing, sales, customer service, and content management through a unified suite of tools designed to drive growth and build stronger customer relationships.
...
2. For full API access to CRM Associations features, you may need a Professional or Enterprise plan subscription, as some API endpoints and rate limits vary based on your subscription tier.
