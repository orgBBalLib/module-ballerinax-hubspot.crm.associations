...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through a unified suite of tools designed to drive growth and enhance customer experiences.
...
final hscrmassociations:Client associationsClient = check new ({
    auth: {
        clientId,
        clientSecret,
        refreshToken
...
public function main() returns error? {
    ...
    hscrmassociations:BatchResponsePublicDefaultAssociation response = check associationsClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(payload);
}
```
