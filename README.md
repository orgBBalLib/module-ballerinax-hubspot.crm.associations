...
2. If you intend to use private apps for API access, note that this feature is available on all HubSpot plans. However, certain CRM association endpoints may require a Professional or Enterprise plan depending on the specific functionality you need to access.
...
3. [CRM association migration](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-association-migration) - Shows how to migrate CRM associations between different objects or systems.
