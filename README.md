...
[HubSpot](https://www.hubspot.com/) is a cloud-based CRM platform that unifies marketing, sales, content management, and customer service tools to help businesses grow better by attracting, engaging, and delighting customers.
...
2. For full access to the CRM Associations API, you will need a Professional or Enterprise plan. However, some basic API functionality is available on the Free and Starter plans with limitations.
