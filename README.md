...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through an integrated suite of tools designed to grow better customer relationships.
...
2. Note that while HubSpot offers a free CRM tier, some API features and higher rate limits require a Professional or Enterprise plan subscription.
