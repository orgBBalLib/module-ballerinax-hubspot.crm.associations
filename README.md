...
2. If you intend to use private apps for API access, note that while free accounts can create private apps, certain API scopes and features may require a Professional or Enterprise plan subscription.
