...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage their marketing, sales, customer service, and content management activities through an integrated suite of tools.
...
2. If you intend to use private apps for API access, note that while free accounts can create private apps, certain CRM API scopes and features may require a Starter, Professional, or Enterprise subscription plan depending on your use case.
...
6. Navigate to the Scopes tab and select the required scopes for the CRM Associations API (e.g., `crm.objects.contacts.read`, `crm.objects.contacts.write`, or other relevant object scopes).

7. Click Create app in the top right corner, then review the information and click Continue creating.

8. Once created, your access token will be displayed. Click Show token to reveal it and copy the token.
