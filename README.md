...
public function main() returns error? {
    crmassociations:BatchInputPublicDefaultAssociationMultiPost batchInput = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    crmassociations:BatchResponsePublicDefaultAssociation response = check crmAssociationsClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(batchInput);
}
```
