...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that provides marketing, sales, customer service, and content management tools to help businesses attract, engage, and delight customers throughout their journey.
...
2. Note that while HubSpot offers a free CRM, access to certain API features may require a Professional or Enterprise plan subscription depending on the endpoints and rate limits you need.
