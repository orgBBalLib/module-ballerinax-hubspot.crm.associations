...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that provides integrated tools for marketing, sales, content management, and customer service to help businesses grow and manage customer relationships effectively.
...
8. In the dialog box, review the information and click **Continue creating**.

9. Once created, your access token will be displayed. Click **Show token** to reveal it.
...
public function main() returns error? {
    hscrmassociations:BatchInputPublicDefaultAssociationMultiPost associationRequest = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    hscrmassociations:BatchResponsePublicDefaultAssociation response = check hscrmassociationsClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(associationRequest);
}
```
...
2. [Deal contact association workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-contact-association-workflow) - Illustrates a workflow for managing associations between deals and contacts in HubSpot CRM.
