...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management with powerful tools to grow better.
...
2. Note that while HubSpot offers a free CRM tier, certain API features and higher rate limits may require a Professional or Enterprise subscription plan.
...
8. In the dialog box, review the access token information and click **Continue creating**.

9. Copy the generated access token displayed on the screen.
