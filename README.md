...
2. [Deal association workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-association-workflow) - Illustrates managing deal associations as part of a complete workflow process.
