...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, content, and customer service operations in one unified system.
...
public function main() returns error? {
    crmassociations:BatchInputPublicAssociationMultiPost payload = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    crmassociations:BatchResponseLabelsBetweenObjectPair|crmassociations:BatchResponseLabelsBetweenObjectPairWithErrors response = 
        check crmassociationsClient->/associations/["contacts"]/["companies"]/batch/create.post(payload);
}
```
