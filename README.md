...
public function main() returns error? {
    hscrmassoc:BatchInputPublicDefaultAssociationMultiPost batchAssociation = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    hscrmassoc:BatchResponsePublicDefaultAssociation response = check hscrmassocClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(batchAssociation);
}
```
