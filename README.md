...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer platform that provides CRM, marketing, sales, and service software to help businesses grow better by connecting their teams, tools, and data in one place.
...
8. Once the private app is created, you will be presented with an access token. Click Show token to reveal it.
...
3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Shows how to create and retrieve associations between HubSpot CRM records.
