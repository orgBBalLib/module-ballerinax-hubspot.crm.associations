...
2. Note that while HubSpot offers a free CRM, access to certain API features may require a Professional or Enterprise plan subscription depending on your integration needs.
...
9. Once created, click **Show token** to reveal your access token.
...
3. [CRM contact association management](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-contact-association-management) - Shows how to manage associations for CRM contacts in HubSpot.
