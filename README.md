...
2. For full API access to CRM associations, you may need a Professional or Enterprise plan subscription, as some API features and rate limits vary based on your subscription tier.
