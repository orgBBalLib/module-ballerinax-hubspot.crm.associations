...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer platform that provides integrated software for marketing, sales, customer service, and content management, helping businesses grow better by connecting their teams and data.
...
2. If you intend to use private apps for API access, note that this feature is available on all HubSpot plans. However, certain CRM Association endpoints may require a Professional or Enterprise plan depending on the specific functionality and objects you need to access.
