...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage their marketing, sales, customer service, and content management operations in one unified system.
...
2. For full access to the CRM Associations API, you need a HubSpot account with a Professional or Enterprise plan subscription. Some association features may be limited on free or Starter plans.
...
6. Navigate to the **Scopes** tab and select the required scopes for CRM Associations. At minimum, enable `crm.objects.contacts.read`, `crm.objects.contacts.write`, and `crm.schemas.contacts.read` along with other object scopes you need to associate.

7. Click **Create app** in the top right corner, then click **Continue creating** to confirm.

8. After the app is created, your access token will be displayed. Click **Show token** to reveal and copy it.
...
#### Create default associations between records
