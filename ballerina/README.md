...
6. Navigate to the Scopes tab and select the required scopes for the CRM Associations API. At minimum, enable `crm.objects.contacts.read`, `crm.objects.contacts.write`, and `crm.objects.companies.read` scopes, or other relevant object scopes based on your association needs.
