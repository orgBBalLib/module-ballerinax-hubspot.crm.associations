...
2. If you intend to use private apps for API access, note that while HubSpot offers free tools, some API features and higher rate limits may require a Professional or Enterprise plan subscription.
