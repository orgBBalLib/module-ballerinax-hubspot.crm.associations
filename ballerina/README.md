...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through an integrated suite of tools designed to drive growth.
...
2. [Enterprise client onboarding sync](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/enterprise-client-onboarding-sync) - Illustrates synchronizing associations during enterprise client onboarding workflows.
