...
public function main() returns error? {
    hscrmassoc:BatchInputPublicDefaultAssociationMultiPost batchRequest = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    hscrmassoc:BatchResponsePublicDefaultAssociation response = check hscrmassocClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(batchRequest);
}
```
...
2. [Deal onboarding associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-onboarding-associations) - Illustrates associating contacts and companies with deals during the onboarding process.
3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Shows how to create associations and retrieve existing associations between records.