...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, content, and customer service operations through an integrated suite of tools designed to drive growth and improve customer relationships.
...
public function main() returns error? {
    crmassociations:BatchInputPublicAssociationMultiPost batchInput = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    crmassociations:BatchResponseLabelsBetweenObjectPair response = check crmAssociationsClient->/associations/["contacts"]/["companies"]/batch/create.post(batchInput);
}
```
...
2. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Illustrates creating associations and retrieving association details.
3. [Merger association management](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/merger-association-management) - Shows how to manage associations during object merging operations.