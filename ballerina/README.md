...
2. If you intend to use private apps for API access, note that this feature is available on all HubSpot plans. However, certain API endpoints and scopes may require a Professional or Enterprise subscription depending on the data you need to access.
