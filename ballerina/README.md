...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through an integrated suite of tools designed to drive growth and build lasting customer relationships.
...
8. Once the private app is created, you will see an access token displayed. Click Show token to reveal it, then copy the token.
...
2. [Deal association workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-association-workflow) - Illustrates managing associations in a deal-centric workflow.
