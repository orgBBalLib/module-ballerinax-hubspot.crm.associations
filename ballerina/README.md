...
2. For full API access to CRM Associations, you may need a Professional or Enterprise plan. However, you can create a free developer test account through the [HubSpot Developer Portal](https://developers.hubspot.com/) for development and testing purposes.
...
6. Navigate to the **Scopes** tab and select the required scopes for CRM Associations. At minimum, enable `crm.objects.contacts.read`, `crm.objects.contacts.write`, and `crm.schemas.contacts.read` depending on your use case.

7. Click **Create app** in the top right corner, then click **Continue creating** to confirm.

8. After the app is created, your access token will be displayed. Copy this token to use with the connector.
