...
2. If you intend to use private apps for API access, note that while free accounts can create private apps, certain CRM API scopes and features may require a Starter, Professional, or Enterprise subscription plan.
...
7. Click Create app in the top right corner, then click Continue creating in the confirmation dialog.

8. Once the app is created, navigate to the Access token section and click Show token to reveal your private app access token.
