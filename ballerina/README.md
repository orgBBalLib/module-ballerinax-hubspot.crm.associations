...
8. Copy the access token displayed on the screen.
...
1. [Create delete associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-delete-associations) - Demonstrates how to create and delete associations between CRM objects using Ballerina connector for HubSpot CRM Associations.
