...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through an integrated suite of tools designed to drive growth and build meaningful customer relationships.
...
public function main() returns error? {
    hscrmassociations:BatchInputPublicAssociationMultiPost batchRequest = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    hscrmassociations:BatchResponseLabelsBetweenObjectPair response = check hscrmassociationsClient->/associations/["contacts"]/["companies"]/batch/create.post(batchRequest);
}
```
...
3. [CRM contact association management](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-contact-association-management) - Shows how to manage associations for CRM contacts.