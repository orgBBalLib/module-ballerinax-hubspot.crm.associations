...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage their marketing, sales, customer service, and content management through an integrated suite of tools designed to grow better.
...
8. A dialog will display your access token. Click Show token to reveal it, then copy the token.
...
#### Associate records using default association type
...
2. [Customer onboarding associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/customer-onboarding-associations) - Illustrates managing associations during customer onboarding workflows.
3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Shows how to create and retrieve associations between HubSpot CRM objects.