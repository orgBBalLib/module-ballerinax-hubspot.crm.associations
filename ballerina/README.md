...
[HubSpot](https://www.hubspot.com/) is a cloud-based CRM platform that unifies marketing, sales, content management, and customer service tools, helping businesses attract, engage, and delight customers throughout their entire journey.
...
3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Shows how to create associations and retrieve existing associations between CRM records.