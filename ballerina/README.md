...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, content, and customer service operations through an integrated suite of tools designed to drive growth and build lasting customer relationships.
...
2. If you intend to use private apps for API access, note that this feature is available on all HubSpot plans. However, certain CRM association features and API rate limits may vary depending on your subscription tier (Starter, Professional, or Enterprise).
