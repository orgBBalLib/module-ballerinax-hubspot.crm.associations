...
public function main() returns error? {
    crmassociations:BatchInputPublicDefaultAssociationMultiPost batchAssociations = {
        inputs: [
            {
                'from: {
                    id: "12345"
    ...
    crmassociations:BatchResponsePublicDefaultAssociation response = check crmAssociationsClient->/associations/["contacts"]/["companies"]/batch/associate/default.post(batchAssociations);
}
```
