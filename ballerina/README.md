...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer platform that provides CRM, marketing, sales, and customer service tools to help businesses grow better by connecting their teams and data in one unified system.
...
6. Navigate to the **Scopes** tab and select the required scopes for CRM associations. At minimum, enable `crm.objects.contacts.read`, `crm.objects.contacts.write`, and other relevant object scopes depending on your use case.
