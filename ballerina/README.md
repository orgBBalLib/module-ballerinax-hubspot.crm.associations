...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that provides integrated tools for marketing, sales, content management, and customer service, helping businesses attract, engage, and delight customers throughout their journey.
...
2. For full API access to CRM Associations, you may need a Professional or Enterprise plan, as some API features and rate limits vary based on your subscription tier.
