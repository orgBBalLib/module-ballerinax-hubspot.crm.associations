...
2. [Customer contact association setup](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/customer-contact-association-setup) - Illustrates setting up associations between customers and their contact records.
3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Shows how to create associations and retrieve existing association data between CRM objects.