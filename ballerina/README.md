...
> **Tip:** You must copy and store this key somewhere safe. It won't be visible again without regenerating a new token, and for security reasons, you should treat it as a sensitive credential.
## Quickstart
...
3. [CRM association sync workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-association-sync-workflow) - Shows how to implement a workflow for synchronizing CRM associations.