...
2. If you intend to use private apps for API access, note that while HubSpot offers free CRM tools, certain API features and higher rate limits may require a paid subscription (Starter, Professional, or Enterprise plan).
