...
http:Service mockService = service object {
    ...
    resource function post associations/usage/high\-usage\-report/[int:Signed32 userId]() returns ReportCreationResponse|error {
        ...
        int timeValueInt = 1739687932759;
        int:Signed32 timeValue = <int:Signed32>(timeValueInt % 2147483647);
        int:Signed32 timeZoneShiftValue = 0;
        ReportCreationResponse response = {
            enqueueTime: {
                value: timeValue,
                dateOnly: false,
                timeZoneShift: timeZoneShiftValue
            },
            userId: userIdValue,
