...
http:Service mockService = service object {
    ...
    resource function post associations/usage/high\-usage\-report/[int:Signed32 userId]() returns ReportCreationResponse|error {
        int valueInt = 1739687932759;
        int:Signed32 valueIntSigned32 = <int:Signed32>(valueInt % 2147483647);
        int:Signed32 timeZoneShiftInt = 0;
        ReportCreationResponse response = {
            enqueueTime: {
                value: valueIntSigned32,
                dateOnly: false,
                timeZoneShift: timeZoneShiftInt
            },
            userId: userId,
