...
public type PublicAssociationMultiWithLabel record {
    ...
    PublicObjectId 'from;
    # Contains pagination cursors for navigating through result sets.
    Paging paging?;
...
public type BatchResponsePublicDefaultAssociation record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully processed default association objects.
...
# Response object containing batch results for multi-labeled associations with processing status.
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully processed multi-labeled association objects.
...
# Paginated collection response containing multi-associated objects with labels.
...
# Response object for batch operations that return no data, with processing status.
public type BatchResponseVoid record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of results from the batch operation (empty for void responses).
    anydata[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
    # The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED", or "COMPLETE"
