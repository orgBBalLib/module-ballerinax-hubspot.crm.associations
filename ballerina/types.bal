...
# Represents associations between objects with their corresponding labels.
...
# Detailed information about a specific error that occurred during processing.
...
# Request object for creating associations with specified types between objects.
...
# Batch response containing labels between object pairs with error details.
