...
# Batch response containing association results with labels and processing status.
...
# Batch response containing labels between object pairs with potential errors.
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of label pairs successfully retrieved between objects.
    LabelsBetweenObjectPair[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
