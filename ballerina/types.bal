...
# Detailed information about a specific error encountered during processing.
...
# Batch request payload for fetching multiple associations.
...
# Response object for batch association operations with labeled relationships.
...
# Paginated collection of associated objects with labels.
...
# Response object for batch operations that return no content on success.
public type BatchResponseVoid record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of empty results for successfully processed items.
    anydata[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
    # The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED", or "COMPLETE"
...
# Request object for fetching associations for a specific object.
