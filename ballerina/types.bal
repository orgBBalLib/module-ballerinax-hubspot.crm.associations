...
# Container for batch association creation requests with multiple inputs.
public type BatchInputPublicAssociationMultiPost record {
    # Array of association records to create in the batch operation.
    PublicAssociationMultiPost[] inputs;
};

# Defines a default association between two objects.
...
# Container for batch requests to fetch associations.
...
# Response containing batch association results with labels and processing status.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    LabelsBetweenObjectPair[] results;
    # Array of standard errors encountered during processing.
    StandardError[] errors?;
