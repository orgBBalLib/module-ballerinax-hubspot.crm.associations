...
# Batch request wrapper for creating multiple default associations.
...
# Batch request wrapper for archiving multiple associations.
...
# Detailed error information for troubleshooting API issues.
...
# Pagination object for forward navigation through result sets.
...
public type BatchInputPublicAssociationMultiPost record {
    # Array of association definitions to create in the batch request.
...
# Response object containing batch results for associations with their labels.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    string startedAt;
    # Map of link names to URIs for related resources or documentation.
    record {|string...;|} links?;
...
# Paginated response containing labeled associations between multiple objects.
