...
# Detailed information about a specific error that occurred.
...
public type BatchResponsePublicAssociationMultiWithLabelWithErrors record {
    ...
    string completedAt;
    # The total count of errors encountered during batch processing.
...
# Response object for batch label operations between object pairs, including errors.
