...
# Request object for creating an association between two objects.
...
public type BatchResponsePublicAssociationMultiWithLabelWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of successfully processed labeled association results.
...
# Request object defining a default association between two HubSpot objects.
...
public type BatchResponsePublicDefaultAssociation record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully created default association results.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    # Map of related resource links for the batch response.
    record {|string...;|} links?;
    # Array of successfully processed label results between object pairs.
    LabelsBetweenObjectPair[] results;
