...
# Request object for creating associations between objects with types.
...
public type BatchResponsePublicAssociationMultiWithLabelWithErrors record {
    # Timestamp indicating when the batch operation finished processing.
    string completedAt;
...
# Response object containing batch association results with labels and processing status.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    # Total count of errors encountered during batch processing.
    int:Signed32 numErrors?;
    # Timestamp when the batch request was initially submitted, in ISO 8601 format.
    string requestedAt?;
...
# Request object for fetching associations in batch for a specific object.
