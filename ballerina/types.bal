...
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of labeled association pairs returned by the batch operation.
...
# Batch request wrapper for creating multiple associations.
...
# Batch request wrapper for fetching multiple association records.
...
# Response object containing batch results for association operations with labels.
...
# Paginated response containing associated objects with labels.
...
# Response object for batch operations that do not return data.
public type BatchResponseVoid record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of empty results for completed batch operations.
    anydata[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
    # The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED", or "COMPLETE"
...
# Request object for fetching associations in batch.
