...
public type BatchInputPublicDefaultAssociationMultiPost record {
    # Array of default association definitions to create.
...
public type BatchInputPublicAssociationMultiArchive record {
    # Array of association definitions to archive.
...
# Request body for creating multiple associations in a single batch operation.
...
# Defines a default association between two objects using their identifiers.
...
# Batch response containing associations with their labels and processing status.
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully processed associations with labels.
    PublicAssociationMultiWithLabel[] results;
...
# Batch response for label operations between object pairs, including any errors.
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    string startedAt;
    # Map of related links for additional resources or documentation.
    record {|string...;|} links?;
