...
# Represents an association between objects with labels and pagination support.
...
# Batch response containing multiple associations with their associated labels.
...
# Batch response containing labels between object pairs, including any errors.
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    string startedAt;
    # Map of related links for documentation or remediation steps.
    record {|string...;|} links?;
    # Array of label objects between object pairs returned from the batch.
    LabelsBetweenObjectPair[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
...
public type ApiKeysConfig record {|
    # The HubSpot API key for authentication
    string hapikey;
    # The private app token for authentication
    string privateApp;
    # The legacy private app token for authentication
