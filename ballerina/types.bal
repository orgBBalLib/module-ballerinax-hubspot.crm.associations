...
# Represents multiple associations with labels between HubSpot objects.
...
# Detailed error information including context and remediation steps.
...
# Forward pagination container for navigating result sets.
...
# Request object for creating associations between multiple objects.
...
# Batch response containing association results with labels and any errors encountered.
...
# Response object containing batch results for associations with labels.
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of association results with their associated labels.
    PublicAssociationMultiWithLabel[] results;
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    string requestedAt?;
    # Timestamp when batch processing started, in ISO 8601 format.
    string startedAt;
    # Map of related resource links for the batch response.
    record {|string...;|} links?;
...
public type ApiKeysConfig record {|
    ...
    string privateApp;
    # Legacy private app access token
