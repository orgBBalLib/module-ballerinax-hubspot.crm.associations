...
# Request wrapper for batch creation of multiple associations.
...
# Request wrapper for batch retrieval of associations.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of label data between object pairs.
    LabelsBetweenObjectPair[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
