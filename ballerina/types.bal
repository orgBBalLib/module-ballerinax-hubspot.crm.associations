...
# Request object for creating associations between objects
...
# Request payload containing multiple association records to create in a single batch operation
public type BatchInputPublicAssociationMultiPost record {
    # Array of association records to be created in the batch request
    PublicAssociationMultiPost[] inputs;
};

# Request payload for creating a default association between two HubSpot objects
...
public type BatchResponsePublicDefaultAssociation record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully created default association records
...
# Response containing batch results for association operations with label information
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully processed association records with labels
    PublicAssociationMultiWithLabel[] results;
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of successfully retrieved labeled associations between object pairs
    LabelsBetweenObjectPair[] results;
...
# A paginated collection of multi-associated objects with their labels
