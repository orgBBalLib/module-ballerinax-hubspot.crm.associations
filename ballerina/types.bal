...
public type PublicAssociationMultiWithLabel record {
    ...
    PublicObjectId 'from;
    # Contains pagination information for navigating through result sets.
    Paging paging?;
...
# Batch response containing labeled associations between object pairs with status info.
...
public type BatchResponseVoid record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Empty array as this batch operation does not return result data.
    anydata[] results;
    # Array of errors encountered during the batch processing operation.
    StandardError[] errors?;
    # The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED", or "COMPLETE"
