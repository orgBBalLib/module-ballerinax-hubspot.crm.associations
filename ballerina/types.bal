...
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of label pairs returned from the batch operation.
...
# Response object containing batch results for associations with label information.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
    # Processing status of the batch operation (CANCELED, COMPLETE, PENDING, or PROCESSING)
    "CANCELED"|"COMPLETE"|"PENDING"|"PROCESSING" status;
};
