...
# Contains forward pagination information for result sets.
...
# Represents a default association between two HubSpot objects.
...
# Batch request payload for fetching multiple association sets.
