...
# Batch request payload for creating multiple default associations.
...
# Batch request payload for archiving multiple associations.
...
# Request payload for creating an association with specified types.
...
# Response object containing association labels between object pairs with error details.
