...
# Represents multiple associations between objects with their labels.
...
# Detailed information about an error that occurred during processing.
...
# Contains pagination information for forward navigation through results.
...
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of label results between object pairs.
...
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully retrieved associations with their labels.
    PublicAssociationMultiWithLabel[] results;
...
# Batch response for label retrieval between object pairs, including any errors.
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    string startedAt;
    # Map of link names to URLs for related documentation or resources.
    record {|string...;|} links?;
