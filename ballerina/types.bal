...
# Batch request wrapper for fetching multiple associations.
...
# Paginated collection response containing associated objects with labels.
...
# Response object for batch operations that return no result data.
public type BatchResponseVoid record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Empty array indicating successful operations with no return data.
    anydata[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
    # The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED", or "COMPLETE"
...
# Request object for fetching associations in batch operations.
