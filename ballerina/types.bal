...
# Batch response containing labeled associations with optional error details and processing status.
public type BatchResponsePublicAssociationMultiWithLabelWithErrors record {
    ...
    string startedAt;
    # Map of related resource links for navigation and discovery.
    record {|string...;|} links?;
...
public type BatchInputPublicAssociationMultiPost record {
    # Array of association definitions to create in the batch operation.
