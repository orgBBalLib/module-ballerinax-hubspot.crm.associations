...
# Response object containing batch operation results with labeled associations.
...
# Response containing labels between object pairs with potential errors.
...
# A paginated collection of associated objects with their labels.
