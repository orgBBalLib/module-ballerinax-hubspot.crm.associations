...
# Represents associations between objects with labels and pagination support.
...
# Batch input container for creating multiple default associations.
...
# Batch input container for archiving multiple associations.
...
# Request body for retrieving multiple associations in a single batch operation.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of successfully retrieved label pairs between objects.
    LabelsBetweenObjectPair[] results;
...
public type ApiKeysConfig record {|
    ...
    string privateApp;
    # Private app legacy access token
