...
public type BatchInputPublicAssociationMultiPost record {
    # Array of association definitions to create in batch.
...
# Batch response containing association labels between object pairs, including any errors.
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    string startedAt;
    # Map of relevant links related to the batch request.
    record {|string...;|} links?;
...
# Paginated collection of multi-associated objects with their labels
public type CollectionResponseMultiAssociatedObjectWithLabelForwardPaging record {
    # Pagination object for forward navigation through result sets.
    ForwardPaging paging?;
    # Array of multi-associated objects with their corresponding labels
