...
public type MultiAssociatedObjectWithLabel record {
    # Array of association types with their labels for this object.
...
public type BatchInputPublicAssociationMultiPost record {
    # Array of association requests to process in batch.
...
# Batch request payload for fetching multiple association records.
...
# Response object for batch operations that return no result data, only status information.
