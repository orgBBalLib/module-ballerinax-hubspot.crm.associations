...
# Request wrapper for batch creating multiple associations with labels.
...
# Request wrapper for batch fetching associations.
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of successfully processed label pairs between objects.
    LabelsBetweenObjectPair[] results;
