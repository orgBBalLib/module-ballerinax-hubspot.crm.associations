...
# Batch response containing labeled associations with optional error details and status.
...
# Batch response containing association results with their associated labels.
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of association results with labels from the batch operation.
    PublicAssociationMultiWithLabel[] results;
...
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    string startedAt;
    # Map of link names to URIs with related documentation or resources.
    record {|string...;|} links?;
    # Array of label results between object pairs from the batch operation.
    LabelsBetweenObjectPair[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
