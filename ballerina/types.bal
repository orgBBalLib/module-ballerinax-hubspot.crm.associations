...
# Response object containing details about a newly created report request.
...
# Represents an association between objects with labeled relationship metadata.
...
# Batch response for association labels between object pairs, including any errors.
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of successfully retrieved association labels between object pairs.
    LabelsBetweenObjectPair[] results;
    # Array of errors encountered during batch processing.
    StandardError[] errors?;
