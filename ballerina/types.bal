...
# Response containing batch results for associations with labels.
...
# Batch response containing association labels between object pairs, including errors.
public type BatchResponseLabelsBetweenObjectPairWithErrors record {
    ...
    # Total count of errors encountered during batch processing.
    int:Signed32 numErrors?;
    # Timestamp when the batch request was initially received.
    string requestedAt?;
