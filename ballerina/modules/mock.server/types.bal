...
public type BatchResponsePublicAssociationMultiWithLabelWithErrorsMultiStatus record {|
    *http:MultiStatus;
...
public type BatchResponseLabelsBetweenObjectPairWithErrorsMultiStatus record {|
    *http:MultiStatus;
