...
3. **HubSpot CRM Records**
   ...
   Ensure you have existing deal and company records in your HubSpot account. Update the following constants in the `main.bal` file with your actual record IDs:
...
Execute the following command to run the example. The script will print the association creation and read responses to the console.
