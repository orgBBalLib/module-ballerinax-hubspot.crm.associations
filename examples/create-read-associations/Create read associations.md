...
3. **HubSpot CRM Data**
   ...
   Ensure you have existing deals and companies in your HubSpot CRM account. Update the following constants in `main.bal` with valid object IDs from your account:
