...
2. **Configuration**
   ...
   > **Note:** You will also need to update the object IDs in the code (`FROM_OBJECT_ID_1`, `TO_OBJECT_ID_1`, `FROM_OBJECT_ID_2`, `TO_OBJECT_ID_2`) with valid deal and company IDs from your HubSpot account.
