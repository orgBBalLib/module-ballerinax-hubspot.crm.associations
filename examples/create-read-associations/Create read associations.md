...
3. **HubSpot Objects Setup**
   ...
   - `FROM_OBJECT_ID_1` - First deal ID
   - `TO_OBJECT_ID_1` - First company ID
   - `FROM_OBJECT_ID_2` - Second deal ID
   - `TO_OBJECT_ID_2` - Second company ID
...
- The read responses displaying all associations for each deal with companies