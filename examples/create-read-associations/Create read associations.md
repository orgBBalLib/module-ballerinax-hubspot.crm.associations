...
2. **Configuration**
   ...
   Create a `Config.toml` file in the project root with your HubSpot OAuth2 credentials:
...
3. **HubSpot Object IDs**
   ...
   Before running the example, update the following constants in the code with valid object IDs from your HubSpot account:
