...
3. **HubSpot CRM Data**
   ...
   Before running this example, ensure you have existing deals and companies in your HubSpot CRM account. Update the following constants in the `main.bal` file with your actual object IDs:
