...
1. **HubSpot Setup**
   > Refer to the [HubSpot setup guide](https://github.com/ballerina-platform/ballerina-central-connectors/blob/main/docs/setup/hubspot/setup.md) to obtain OAuth2 credentials.
...
3. **HubSpot CRM Data**
   ...
   Before running this example, ensure you have existing deals and companies in your HubSpot account. Update the following constants in the code with your actual object IDs:
