...
3. **HubSpot CRM Data**
   ...
   Ensure you have existing deals and companies in your HubSpot CRM account. Update the following constants in the `main.bal` file with valid object IDs from your HubSpot account:
   
   - `FROM_OBJECT_ID_1` - A valid deal ID
   - `TO_OBJECT_ID_1` - A valid company ID
   - `FROM_OBJECT_ID_2` - Another valid deal ID
   - `TO_OBJECT_ID_2` - Another valid company ID
...
- The associations read back for each deal with their linked companies