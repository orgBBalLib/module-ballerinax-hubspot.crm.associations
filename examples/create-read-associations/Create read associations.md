...
3. **HubSpot CRM Data**
   ...
   Ensure you have existing deals and companies in your HubSpot CRM account. Update the following constants in the code with valid object IDs from your account:
