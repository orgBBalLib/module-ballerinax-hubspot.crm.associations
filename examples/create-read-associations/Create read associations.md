...
3. **HubSpot CRM Data**
   ...
   Before running this example, ensure you have existing deals and companies in your HubSpot CRM account. Update the following constants in `main.bal` with your actual object IDs:
