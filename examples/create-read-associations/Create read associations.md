...
2. **Configuration**
   ...
   > **Note:** Before running this example, ensure you have valid deal and company object IDs in your HubSpot account. Update the `FROM_OBJECT_ID_1`, `TO_OBJECT_ID_1`, `FROM_OBJECT_ID_2`, and `TO_OBJECT_ID_2` constants in the code with your actual object IDs.
