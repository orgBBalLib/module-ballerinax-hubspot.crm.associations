...
This example demonstrates how to create and read associations between HubSpot CRM objects using the HubSpot CRM Associations connector. The script creates both default and custom-labeled associations between deals and companies, then retrieves and displays the created associations.
...
1. Create default associations between deals and companies in batch
2. Create custom-labeled associations between deals and companies in batch
