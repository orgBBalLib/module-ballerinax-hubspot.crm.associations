...
2. [Deal association workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-association-workflow) - Automate the workflow of associating deals with contacts and companies in HubSpot CRM.
