...
3. [CRM association sync workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-association-sync-workflow) - Implement a complete workflow to synchronize associations between CRM objects in HubSpot.
