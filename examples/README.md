...
2. [CRM association sync](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-association-sync) - Synchronize associations between CRM records across different object types in HubSpot.
