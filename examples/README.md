...
2. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Illustrate how to create associations between CRM objects and retrieve them.

3. [CRM association migration](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-association-migration) - Migrate associations between CRM objects from one configuration to another.
