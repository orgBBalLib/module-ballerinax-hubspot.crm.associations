...
2. [Deal contact association workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-contact-association-workflow) - Manage the workflow of associating deals with contacts in HubSpot CRM.
