...
2. [Deal association workflow](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-association-workflow) - Implement a workflow to manage associations related to deals in the HubSpot CRM.

3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Create associations between CRM objects and retrieve them for verification.
