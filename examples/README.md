...
2. [Enterprise onboarding associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/enterprise-onboarding-associations) - Manage associations for enterprise customer onboarding workflows in HubSpot CRM.

3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Create associations between CRM objects and retrieve existing associations.
