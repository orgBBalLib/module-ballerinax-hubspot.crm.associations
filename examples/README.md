...
2. [Deal onboarding associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/deal-onboarding-associations) - Associate contacts and companies with deals during the onboarding process in HubSpot CRM.

3. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Create associations between CRM objects and retrieve the association details from HubSpot.
