...
2. **Configuration**
   ...
   > **Note:** You will also need valid HubSpot object IDs for the deal and company you want to associate. Update the `FROM_OBJECT_ID` and `TO_OBJECT_ID` constants in the code with your actual object IDs.
