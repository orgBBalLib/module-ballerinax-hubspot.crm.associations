...
1. **HubSpot Setup**
   > Refer to the [HubSpot setup guide](https://central.ballerina.io/ballerinax/hubspot.crm.associations/latest) to obtain OAuth2 credentials.
...
2. **Configuration**
   ...
   > **Note:** You will also need to update the `FROM_OBJECT_ID` and `TO_OBJECT_ID` constants in `main.bal` with valid deal and company IDs from your HubSpot account.
