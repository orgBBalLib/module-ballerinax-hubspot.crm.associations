...
3. **HubSpot CRM Data**
   Ensure you have existing deal and company records in your HubSpot CRM account. Update the `FROM_OBJECT_ID` and `TO_OBJECT_ID` constants in the code with valid object IDs from your HubSpot account.
