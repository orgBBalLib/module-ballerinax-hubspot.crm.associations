...
3. **HubSpot CRM Objects**
   ...
   Ensure you have existing Deal and Company records in your HubSpot account. Update the following constants in the `main.bal` file with valid object IDs from your HubSpot account:
