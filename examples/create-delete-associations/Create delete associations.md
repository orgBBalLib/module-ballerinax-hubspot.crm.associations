...
This example demonstrates how to manage CRM associations between HubSpot objects (deals and companies) using the HubSpot CRM Associations connector. The script creates default and labeled associations, reads existing associations, and deletes specific or all associations between objects.
