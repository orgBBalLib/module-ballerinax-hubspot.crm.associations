...
- The response from creating a default association between a deal and a company
- The response from creating an association with a custom label
- The current associations between the objects
