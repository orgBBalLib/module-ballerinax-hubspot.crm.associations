...
2. **Configuration**
   ...
   > **Note:** Ensure you have valid deal and company object IDs in your HubSpot account. Update the `FROM_OBJECT_ID` and `TO_OBJECT_ID` constants in `main.bal` with your actual object IDs.
