...
### Added
- Added new resource method: post associations/usage/high-usage-report/{userId}
- Added comprehensive documentation comments for all types and fields
- Added hapikey field to ApiKeysConfig for API key authentication
...
- ApiKeysConfig structure changed: added hapikey field, reordered fields
...
- Batch response status enum value changed from 'CANCELED' to 'CANCELLED' in some types
- Removed API key header injection logic - authentication mechanism changed

### Fixed
- Simplified authentication logic in init method
- Removed redundant header manipulation code
- Cleaned up HTTP client configuration
