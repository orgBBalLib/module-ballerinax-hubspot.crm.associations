...
- Added new enum value 'WORK' to association categories
...
- Enum value changes in AssociationSpec and AssociationSpecWithLabel: enum order changed and new 'WORK' category added

### Fixed
- Fixed field types from int to string for object IDs to match API specification
- Corrected method comments to better reflect actual functionality
- Fixed resource path structure for some endpoints
