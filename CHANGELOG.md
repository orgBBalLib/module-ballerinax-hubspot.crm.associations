...
- Added comprehensive documentation comments for types and fields
...
- Changed AssociationSpecWithLabel.label from string? to string (removed nullable)
- Reordered enum values in multiple status and category fields
- Modified ApiKeysConfig structure: reordered fields and added hapikey field

### Fixed
- Simplified authentication handling in client initialization
- Removed redundant header manipulation code
- Improved type safety by removing nullable types where appropriate
