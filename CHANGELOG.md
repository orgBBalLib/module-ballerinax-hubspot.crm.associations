...
### Fixed
- Fixed inconsistent field types for object IDs (int to string)
- Standardized return types by removing error-specific variants
- Updated resource path structure for better API consistency
