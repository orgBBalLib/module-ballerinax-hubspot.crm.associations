...
### Added
- Added new type 'BatchResponseVoid' for batch operations that don't return data
- Added comprehensive documentation comments to all types and fields
- Added new method comments with improved descriptions
...
- Method signature changed for 'delete objects/[string objectType]/[string objectId]/associations/[string toObjectType]/[string toObjectId]' - return type comment changed from 'Returns http:Response with status 204 No Content' to 'No content'
...
- Removed error response union types that were likely incorrectly specified
- Fixed method parameter handling for default association creation
